...
class ApplicantSeeder extends Seeder
{
    public function run(): void
    {
        ...
        \App\Models\ApplicantSkill::truncate();
        \App\Models\ApplicantWorkHistory::truncate();
        \App\Models\ApplicantEducation::truncate();
        \App\Models\ApplicantDocument::truncate();
        \App\Models\ApplicantReference::truncate();
        \App\Models\ApplicantHistory::truncate();
        \App\Models\ApplicantFamily::truncate();
        Applicant::truncate();
        ...
        $seedData = [
            ...
            // ── STAGE: PROFILING (All applicants initialized for Profiling) ──
            [
                ...
                'experience_summary' => '3 years hospitality front desk', 'stage' => 'profiling', 'status' => 'active',
                'sent_to_recruitment' => false, 'submission_source' => 'staff',
                ...
                'history' => [['date' => 'Jul 05, 2026', 'text' => 'Applicant registered'], ['date' => 'Jul 06, 2026', 'text' => 'Ready for Profiling']],
            ],
            [
                ...
                'experience_summary' => '3 yrs Housekeeping and hotel facilities operations', 'stage' => 'profiling', 'status' => 'active',
                'sent_to_recruitment' => false, 'submission_source' => 'staff',
                ...
                'history' => [
                    ['date' => 'Jul 01, 2026', 'text' => 'Applicant registered and queued for Profiling'],
                ],
            ],
            [
                ...
                'experience_summary' => '2 yrs F&B service crew and food handling', 'stage' => 'profiling', 'status' => 'active',
                'sent_to_recruitment' => false, 'submission_source' => 'staff',
                ...
                'history' => [
                    ['date' => 'Jul 05, 2026', 'text' => 'Applicant registered and ready for Profiling'],
                ],
            ],
            [
                ...
                'gender' => 'Male', 'civil_status' => 'Single', 'nationality' => 'Filipino',
                'category' => 'Food & Beverage (F&B / Cook)', 'target_job_id' => 'jo2',
                'experience_summary' => '1.5 yrs F&B service and dining assistant', 'stage' => 'profiling', 'status' => 'active',
                'sent_to_recruitment' => false, 'submission_source' => 'staff',
                ...
                'history' => [
                    ['date' => 'Jul 10, 2026', 'text' => 'Applicant registered and ready for Profiling'],
                ],
            ],
            [
                ...
                'experience_summary' => '2 yrs Line Cook and commercial kitchen assistant', 'stage' => 'profiling', 'status' => 'active',
                'sent_to_recruitment' => false, 'submission_source' => 'staff',
                ...
                'history' => [
                    ['date' => 'Jul 12, 2026', 'text' => 'Applicant registered and ready for Profiling'],
                ],
            ],
            [
                ...
                'experience_summary' => '1 yr Front Desk Receptionist', 'stage' => 'profiling', 'status' => 'active',
                'sent_to_recruitment' => false, 'submission_source' => 'staff',
                ...
                'history' => [
                    ['date' => 'Jul 15, 2026', 'text' => 'Applicant registered and ready for Profiling'],
                ],
            ],
            [
                ...
                'experience_summary' => '1 yr Warehouse packing and logistics sorting', 'stage' => 'profiling', 'status' => 'active',
                'sent_to_recruitment' => false, 'submission_source' => 'staff',
                ...
                'history' => [
                    ['date' => 'Jul 20, 2026', 'text' => 'Applicant registered and ready for Profiling'],
                ],
            ],
            [
                ...
                'gender' => 'Male', 'civil_status' => 'Single', 'nationality' => 'Filipino',
                'category' => 'Hospitality & Front Desk', 'target_job_id' => 'jo1',
                'experience_summary' => '6 months hotel housekeeping trainee', 'stage' => 'profiling', 'status' => 'active',
                'sent_to_recruitment' => false, 'submission_source' => 'staff',
                ...
                'history' => [
                    ['date' => 'Jul 08, 2026', 'text' => 'Applicant registered and ready for Profiling'],
                ],
            ],
        ];
