...
export const JOB_ORDERS = [
  { id: 'jo1', title: 'Housekeeping Supervisor', client: 'Seda Vertis North', depRef: 'JO-001' },
  { id: 'jo2', title: 'F&B Service Crew', client: 'Vikings Luxury Buffet', depRef: 'JO-002' },
  { id: 'jo3', title: 'Cook / Kitchen Staff', client: 'Y2 Hotel Residence', depRef: 'JO-012' },
  { id: 'jo4', title: 'Front Desk Associate', client: 'City Garden Hotel', depRef: 'JO-013' },
  { id: 'jo5', title: 'Warehouse Associate', client: 'ABC Logistics', depRef: 'JO-014' },
];
...
export const APPLICATIONS = [
  { name: 'Andrea Molina', jobId: 'jo1', status: 'for_deployment', score: 94, applied: 'Jul 01, 2026', experience: '3 yrs Housekeeping', location: 'Quezon City',
  ...
  { name: 'Jomar Villagracia', jobId: 'jo2', status: 'contract_signing', score: 89, applied: 'Jul 05, 2026', experience: '2 yrs F&B', location: 'Pasig City',
  ...
  { name: 'Michael Tan', jobId: 'jo2', status: 'hr_requirements', score: 85, applied: 'Jul 10, 2026', experience: '1.5 yrs F&B', location: 'Mandaluyong',
  ...
  { name: 'Carlo Dizon', jobId: 'jo3', status: 'client_interview', score: 88, applied: 'Jul 12, 2026', experience: '2 yrs Line Cook', location: 'Makati City',
  ...
  { name: 'Bea Fernandez', jobId: 'jo4', status: 'area_manager', score: 79, applied: 'Jul 15, 2026', experience: '1 yr Front Desk', location: 'Manila',
  ...
  { name: 'Rico Manalo', jobId: 'jo5', status: 'pooling', score: 75, applied: 'Jul 20, 2026', experience: '1 yr Warehouse', location: 'Valenzuela',
  ...
  { name: 'Vince Ocampo', jobId: 'jo1', status: 're_pooling', score: 62, applied: 'Jul 08, 2026', experience: '0.5 yr', location: 'Caloocan',
