import { JOB_TARGETS, targetById } from '../../applicant-registration/services/ApplicantRegistrationService';
...
export const APPLICATIONS = [
  {
    name: 'Ronaldo Tolentino', jobId: 'jo22', status: 'client_interview', score: 88, applied: 'Aug 29, 2026', experience: '4 yrs Property Administration & Safety', location: 'Valenzuela City',
    breakdown: { skills: 90, experience: 88, screening: 86, availability: 92 },
    interview: null,
    notes: [{ text: 'Endorsed by Area Manager to Prime Realty Corp for Client Final Interview.', meta: 'Area Manager · Aug 29, 2026' }]
  },
  {
    name: 'Carlo Dizon', jobId: 'jo20', status: 'client_interview', score: 88, applied: 'Jul 12, 2026', experience: '2 yrs Line Cook', location: 'Makati City',
    breakdown: { skills: 90, experience: 85, screening: 86, availability: 92 },
    interview: { title: 'Client Final Interview', date: 'Jul 26, 2026', time: '2:00 PM', recruiter: 'Sunrise Hospitality HR' },
    notes: [{ text: 'Endorsed by Area Manager for Final Interview with Client Sunrise Hospitality Group.', meta: 'Area Manager · Jul 18, 2026' }]
  },
  {
    name: 'Andrea Molina', jobId: 'jo19', status: 'for_deployment', score: 94, applied: 'Jul 01, 2026', experience: '3 yrs Housekeeping', location: 'Quezon City',
    breakdown: { skills: 95, experience: 92, screening: 94, availability: 98 }, interview: null,
    notes: [{ text: 'Passed Client Final Interview. Pre-employment requirements and contract signing completed.', meta: 'Area Manager · Jul 20, 2026' }]
  },
  {
    name: 'Jomar Villagracia', jobId: 'jo18', status: 'contract_signing', score: 89, applied: 'Jul 05, 2026', experience: '2 yrs F&B', location: 'Pasig City',
  ...
  {
    name: 'Michael Tan', jobId: 'jo18', status: 'hr_requirements', score: 85, applied: 'Jul 10, 2026', experience: '1.5 yrs F&B', location: 'Mandaluyong',
  ...
  {
    name: 'Bea Fernandez', jobId: 'jo17', status: 'area_manager', score: 79, applied: 'Jul 15, 2026', experience: '1 yr Front Desk', location: 'Manila',
  ...
  {
    name: 'Vince Ocampo', jobId: 'jo2', status: 're_pooling', score: 62, applied: 'Jul 08, 2026', experience: '0.5 yr Forklift', location: 'Caloocan',
    breakdown: { skills: 60, experience: 50, screening: 68, availability: 75 }, interview: null,
    notes: [{ text: 'Client interview result: Returned to Main Office Pooling for line-up to other clients.', meta: 'Area Manager · Jul 19, 2026' }]
  }
];